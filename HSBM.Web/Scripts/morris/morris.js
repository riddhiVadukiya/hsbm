...
(function () {
    ...
    Morris.Line = (function (_super) {
        ...
        Line.prototype.drawLinePath = function (path, lineColor, lineIndex) {
            return this.raphael.path(path).attr('stroke', lineColor).attr('fill', lineColor).attr('stroke-width', this.lineWidthForSeries(lineIndex));
        };
    ...
    Morris.Pie = (function (_super) {
        ...
        Pie.prototype.pieDefaults = {
            colors: ['#06375c', '#084574', '#09548c', '#0b62a4', '#0d70bc', '#095791', '#095085', '#083E67', '#052C48', '#042135'],
            // colors: ['#0B62A4', '#3980B5', '#679DC6', '#95BBD7', '#B0CCE1', '#095791', '#095085', '#083E67', '#052C48', '#042135'],
            idKey: "label",
            stroke: "#FFFFFF",
            strokeWidth: 3,
    ...
    Morris.Pie.FullSector = (function (_super) {
        ...
        FullSector.prototype.render = function (r) {
            var _this = this;
            this.sec = r.circle(this.cx, this.cy, this.radius - this.options.drawOut).attr({
                fill: this.color,
